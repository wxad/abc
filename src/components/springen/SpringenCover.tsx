const Cover = () => {
  return (
    <div className="relative">
      ...
      <div
        className="absolute inset-0 bg-[length:40px_40px] border border-neutral-300 overflow-hidden rounded-full flex items-center justify-center gap-2 bg-black"
      >
        <svg className="rotate-90" width="36" height="36" viewBox="0 0 24 24">
          <path
            fill="#fff"
        ...
        <div className="font-semibold text-[26px] text-white">Springen</div>
      </div>
    </div>
  )
}
