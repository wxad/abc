const CarouselCover = () => {
  return (
    <div className="relative">
      ...
      >
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-10 w-[200px] h-0.5 bg-neutral-300 rounded-sm">
          <div
          ...
          <div
            className="absolute top-[-7px] left-[-8px] w-4 h-4 bg-neutral-300 border border-white rounded-full touch-none"
            style={{
              animation: "traildot 4s ease both infinite",
            }}
          />
