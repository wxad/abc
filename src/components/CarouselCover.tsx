  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="absolute top-1/2 left-[78%] transform -translate-y-[43%] rotate-[10deg] w-[150px] h-[225px] bg-neutral-200 border-dashed border border-neutral-400 rounded-[10px] shadow-sm" />
        <div className="absolute top-1/2 right-[78%] transform -translate-y-[43%] rotate-[-10deg] w-[150px] h-[225px] bg-neutral-200 border-dashed border border-neutral-400 rounded-[10px] shadow-sm" />
      </div>
    </div>
  )
}
