...
const Demo = () => {
  ...
  return (
    <DemoBox className="flex justify-center items-center p-6">
      <div
        ref={ref}
        className="relative w-[250px] aspect-[670/1080] rounded-xl overflow-hidden"
      >
        <video
          ref={videoRef}
          ...
          src="https://wxa.wxs.qq.com/wxad-design/yijie/making-fluid-interfaces/hx-perform.mp4"
        />
        <div
          ref={coverRef}
