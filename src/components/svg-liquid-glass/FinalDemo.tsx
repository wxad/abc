...
const Demo = ({ src }: { src: string }) => {
  ...
  return (
    ...
    >
      <video
        ref={videoRef}
        className="absolute-full rounded-md object-cover"
        muted
        preload="auto"
      ...
      <div
        ref={coverRef}
        className="absolute-full hidden items-center justify-center font-medium text-sm text-neutral-500 bg-linear-to-bl from-white to-neutral-100 border border-sold border-neutral-200 cursor-pointer rounded-md opacity-95 backdrop-blur-xl"
        onClick={() => {
