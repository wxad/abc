...
const getFullGradients = (gradients: typeof oranges) => {
  return [
    `conic-gradient(from 180deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 41deg, ${gradients["2"]} 67deg, ${gradients["3"]} 90deg, ${gradients["4"]} 153deg, ${gradients["5"]} 221.3deg, ${gradients["6"]} 221.53deg, ${gradients["7"]} 270deg, ${gradients["8"]} 333deg, ${gradients["9"]} 360deg)`,
    `conic-gradient(from 180deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 32deg, ${gradients["2"]} 58deg, ${gradients["3"]} 79deg, ${gradients["4"]} 126deg, ${gradients["5"]} 187deg, ${gradients["6"]} 223.2deg, ${gradients["7"]} 259deg, ${gradients["8"]} 324deg, ${gradients["9"]} 360deg)`,
    `conic-gradient(from 173deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 32deg, ${gradients["2"]} 55deg, ${gradients["3"]} 76deg, ${gradients["4"]} 113deg, ${gradients["5"]} 188deg, ${gradients["6"]} 228deg, ${gradients["7"]} 254deg, ${gradients["8"]} 313deg, ${gradients["9"]} 360deg)`,
    `conic-gradient(from 130deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 61deg, ${gradients["2"]} 76deg, ${gradients["3"]} 111deg, ${gradients["4"]} 151deg, ${gradients["5"]} 223deg, ${gradients["6"]} 248deg, ${gradients["7"]} 270deg, ${gradients["8"]} 349deg, ${gradients["9"]} 360deg)`,
    `conic-gradient(from 119deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 43deg, ${gradients["2"]} 61deg, ${gradients["3"]} 97deg, ${gradients["4"]} 115deg, ${gradients["5"]} 212deg, ${gradients["6"]} 244deg, ${gradients["7"]} 259deg, ${gradients["8"]} 342deg, ${gradients["9"]} 360deg)`,
    `conic-gradient(from 112deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 29deg, ${gradients["2"]} 39deg, ${gradients["3"]} 68deg, ${gradients["4"]} 90deg, ${gradients["5"]} 104deg, ${gradients["6"]} 234deg, ${gradients["7"]} 248deg, ${gradients["8"]} 281deg, ${gradients["9"]} 360deg)`,
    // 08 ${gradients["8"]} -> ${gradients["8-new"]}
    `conic-gradient(from 65deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 36deg, ${gradients["2"]} 65deg, ${gradients["3"]} 86deg, ${gradients["4"]} 108deg, ${gradients["5"]} 133deg, ${gradients["6"]} 216deg, ${gradients["7"]} 259deg, ${gradients["8-new"]} 299deg, ${gradients["9"]} 360deg)`,
    // 01 ${gradients["1"]} -> ${gradients["1-new"]}
    `conic-gradient(from 0deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1-new"]} 32deg, ${gradients["2"]} 79deg, ${gradients["3"]} 122deg, ${gradients["4"]} 130deg, ${gradients["5"]} 180deg, ${gradients["6"]} 230deg, ${gradients["7"]} 270deg, ${gradients["8-new"]} 313deg, ${gradients["9"]} 360deg)`,
    `conic-gradient(from -58deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1-new"]} 58deg, ${gradients["2"]} 104deg, ${gradients["3"]} 133deg, ${gradients["4"]} 176deg, ${gradients["5"]} 238deg, ${gradients["6"]} 284deg, ${gradients["7"]} 299deg, ${gradients["8-new"]} 328deg, ${gradients["9"]} 360deg)`,
    // 01 ${gradients["1-new"]} -> ${gradients["1"]}
    `conic-gradient(from -173deg at 49.99% 60%, ${gradients["9"]} 0deg, ${gradients["1"]} 83deg, ${gradients["2"]} 155deg, ${gradients["3"]} 169deg, ${gradients["4"]} 187deg, ${gradients["5"]} 292deg, ${gradients["6"]} 310deg, ${gradients["7"]} 328deg, ${gradients["8-new"]} 342deg, ${gradients["9"]} 360deg)`,
...
const Demo = () => {
  ...
  const [scene, setScene] = useState<"moments" | "channels">("moments")
      ...
      >
        <div className="relative w-80 h-80 overflow-hidden rounded-lg">
          <div className="absolute-full">
            <motion.div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-80 scale-x-[4]"
              style={{
