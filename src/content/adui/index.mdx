...
<img
  className="block mt-8 mb-2 w-full outline-solid -outline-offset-8 outline-8 outline-white overflow-hidden rounded-xl grayscale"
  src="https://wxa.wxs.qq.com/wxad-design/yijie/tabs-bounce-9877.gif"
/>

<img
  className="block mb-8 w-full outline-solid -outline-offset-8 outline-8 outline-white overflow-hidden rounded-xl grayscale"
...
<img
  className="block mx-auto my-8 max-w-[600px] w-full outline-solid -outline-offset-8 outline-8 outline-[#fcfcfc] overflow-hidden rounded-xl grayscale"
...
<img
  className="block mx-auto my-8 w-full outline-solid -outline-offset-8 outline-8 outline-[#fcfcfc] overflow-hidden rounded-xl grayscale"
