---
title: "做 UI 的开发"
description: "你想当一个诗人的时候，你就失去了诗。你想成为一个人的时候，你就失去了你自己。在你什么也不想要的时候，或许一切才如期而来。"
slug: "deng"
...
兴奋无用，交流无用，鼓励也无用。我开始认为，除非你能够意识到自己是一个适合做那件事的人，否则那些教不来的东西，你真的不用学。
...
如果一个前端工程师能够生出、或还能保留这些想法，那么他就是一个适合做 UI 的开发。这无关岗位划分，这也没有自我约束，只要有这一点执着，他就是一个适合做 UI 的开发。

## 适合，本来就很难咯

我并不认为做 UI 这件事就能够代表什么。做 UI 的价值可能确实不大，但我会停止讨论这件事。正如我所说，理性与感性上自己都应该少一些兴奋或质疑。渴望燃烧，就是渴望化为灰烬。
...
组里来来去去，留下的工程师不过自己。我并不将这归结于缘分。适合很难。我开始不追求互相理解，因为我们本就无法。

我开始警惕要求与被要求。每个人得好好拥抱自己吧。
