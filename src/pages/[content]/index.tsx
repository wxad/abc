...
export default function PostPage({ content }: { content: Post }) {
  ...
  return (
    <div className="m-auto px-4 pt-8 md:pt-16 pb-28 w-[min(80rem,100%)] text-sm md:text-base">
      ...
      {/* <nav className="fixed 74:hidden bottom-0 py-6 px-4 left-1/2 transform -translate-x-1/2 z-20 w-[min(800px,100vw)]">
        <div className="flex items-center justify-between px-4 h-[48px] bg-neutral-100/90 backdrop-blur-xs rounded-xl shadow-md">
          <NextLink
