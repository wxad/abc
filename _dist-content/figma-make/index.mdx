...
这个方向没有问题。只是它不是我想要在这里讨论的，因为我作为设计工程师选择的是另一个方向。我一行 GLSL 或后台的代码都不会写，AI 却可以替我实现。我很自然地更加认同 Ryo 所持的立场，因为我的工作根本脱离不开 [真实的材料](https://x.com/raunofreiberg/status/1941212643043561948)。
