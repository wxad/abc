...
import LikeBM24Final from "@/components/likes/LikeBM24Final"
import LikeBM24 from "@/components/likes/LikeBM24"
import LikeBM23 from "@/components/likes/LikeBM23"
import LikeBM23Curve from "@/components/likes/LikeBM23Curve"
import LikeBM23Mask from "@/components/likes/LikeBM23Mask"
...
import { likesVideoSrc } from "@/components/likes/videoCdn"
...
来自于 [微信广告 11 周年活动](https://wxad.design/abc/wxad11#点赞动画)。点赞如果只是数字的增加就太没有氛围了，我们可以把两根应援棒变成烟花棒玩玩：
...
<LikeBM24 src={likesVideoSrc.likebm24_0} aspectRatio="494 / 1080" />

上面的氛围感有点不足，因此我和设计师加大了一些爱心的尺寸：

<LikeBM24 src={likesVideoSrc.likebm24_1} aspectRatio="554 / 1080" />

但票数和爱心之间没有关联。我们需要投票 -> 动画 -> 票数增加的示意更加明确，因此我们需要一个类似于这样汇聚到上方的动画，在汇聚后票数增加：

<LikeBM24 src={likesVideoSrc.likebm24_2} aspectRatio="554 / 1080" />

最后设计师为我绘制了两套路径，整个动画通过 `offset-path` 配合 `motion/react` 实现：

<LikeBM24Final
  videoSrc={likesVideoSrc.likebm24_3}
  imgSrc="/abc/likes/likebm24-path-0.webp"
/>

<LikeBM24Final
  videoSrc={likesVideoSrc.likebm24_4}
  imgSrc="/abc/likes/likebm24-path-1.webp"
/>
